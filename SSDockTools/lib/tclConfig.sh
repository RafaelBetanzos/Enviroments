...
# installed.
TCL_PREFIX='/home/rbetanzos/git-holcan/enviroments/SSDockTools'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/rbetanzos/git-holcan/enviroments/SSDockTools'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/rbetanzos/git-holcan/enviroments/SSDockTools/include -fdebug-prefix-map=/opt/conda/conda-bld/tk_1654088763175/work=/usr/local/src/conda/tk-8.6.12 -fdebug-prefix-map=/home/rbetanzos/git-holcan/enviroments/SSDockTools=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/rbetanzos/git-holcan/enviroments/SSDockTools/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/rbetanzos/git-holcan/enviroments/SSDockTools/lib -Wl,-rpath-link,/home/rbetanzos/git-holcan/enviroments/SSDockTools/lib -L/home/rbetanzos/git-holcan/enviroments/SSDockTools/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/rbetanzos/git-holcan/enviroments/SSDockTools/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/rbetanzos/git-holcan/enviroments/SSDockTools/include'
...
TCL_PACKAGE_PATH='{/home/rbetanzos/git-holcan/enviroments/SSDockTools/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/rbetanzos/git-holcan/enviroments/SSDockTools/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/opt/conda/conda-bld/tk_1654088763175/work/tcl8.6.12/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/rbetanzos/git-holcan/enviroments/SSDockTools/lib/libtclstub8.6.a'
